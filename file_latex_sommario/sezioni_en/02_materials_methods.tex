...
noisy AQFT tests. Qiskit/Aer, scikit-learn, Stim, and PyMatching are used
\cite{en-qiskit2023,en-scikit_learn,en-stim2021,en-pymatching2021}, recording versions,
...
\cite{en-steane1996,en-fowler2012} are studied in memory circuits through the logical
...
lower depth, and fewer opportunities for noise. Truncation of Shor's final inverse QFT
