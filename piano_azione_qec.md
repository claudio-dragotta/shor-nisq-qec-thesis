...
| M6 Steane [[7,1,3]] | ❌ NUOVO | codice CENTRALE: stabilizzatori, preparazione \|0_L⟩, iniezione X/Y/Z su ciascuno dei 7 qubit, syndrome table, lookup decoder, curva p vs successo correzione, errori data vs ancilla |
| M7 surface code | ❌ NUOVO | Stim + PyMatching, d=3,5,7, rounds ∈ {d, 2d}, curve p vs p_L, memory X e Z, comportamento threshold-like |
