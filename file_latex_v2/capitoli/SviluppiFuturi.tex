...
La scalabilità va studiata variando anche l'ordine moltiplicativo $r$. $N=35$, $a=6$ ha ordine 2, mentre $N=21$, $a=2$ ha ordine 6. Un numero più grande non rende quindi automaticamente più difficile la ricerca del periodo. Dimensione del registro e ordine devono essere variati e dichiarati separatamente.
...
Per la decodifica appresa, modelli a grafo o convoluzionali potrebbero usare meglio la disposizione locale dei qubit. Altre possibilità sono includere la storia dei cicli di misura e i segnali analogici, oltre agli esiti binari. Queste estensioni aggiungono relazioni o informazione al problema. Il loro beneficio va confrontato con quello ottenuto semplicemente ingrandendo una rete densa sullo stesso vettore di sindrome.
