...
e documentate nella Sezione~\ref{sec:app_aqft}.}
...
Tabella~\ref{tab:frazione_coerente} e la
Figura~\ref{fig:frazione_coerente} definiscono l'indice descrittivo e mostrano
lo scarto dal proxy di nessun evento. Gli sweep precedenti ne conservano qui
il contesto parametrico.
