...
Il confronto principale usa $N=15$, $a=7$, e i due preset uniformi della Tabella~\ref{tab:contratto_n15}. Questi non riproducono la calibrazione di una QPU specifica. Le altre istanze servono a verificare l'aritmetica ideale e i costi; i test AQFT rumorosi su $N=21$ sono una campagna esplorativa separata. Scelte aritmetiche e perimetro completo sono nella Sezione~\ref{app:shor_perimetro_esteso}.
...
M1 prova un candidato; TOP-4 ne prova fino a quattro. M2 prova gli stessi quattro solo se il classificatore accetta l'istogramma. Dataset, modello TOP-1 e controllo TOP-16 sono nella Sezione~\ref{app:classificatore}. Ogni scenario comprende 30 repliche, con un massimo di 50 iterazioni. Ai fallimenti si assegna il valore 51, per conservarli nel confronto. I test M1$>$TOP-4 e M1$>$M2 sono Wilcoxon appaiati unilaterali, con \texttt{zero\_method='pratt'}; il confronto TOP-4--M2 è bilaterale. Le correzioni per confronti multipli si applicano alla famiglia dichiarata. Medie e tassi descrivono i risultati, mentre i test usano tutte le repliche appaiate.
