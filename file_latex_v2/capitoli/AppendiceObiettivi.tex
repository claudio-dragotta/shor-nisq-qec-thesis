...
\noindent\textit{Origine nel corpo:} definizioni operative estese della
sintesi del contratto sperimentale nella Sezione~\ref{sec:metriche} e della
Sezione~\ref{subsec:metriche_qec}.
...
La metrica descrittiva principale è il fattore di riduzione
$\rho=\bar{M}_1/\bar{M}_2$ definito nella Sezione~\ref{sec:metriche}.
$\rho>1$ indica soltanto una media inferiore per il metodo al denominatore: la
significatività viene stabilita sulle differenze appaiate e non dedotta dal
rapporto fra medie.
