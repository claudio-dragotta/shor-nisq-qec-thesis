...
% -----------------------------------------------
\chapter{Fondamenti del Calcolo Quantistico --- Trattazione Estesa}
\label{app:fondamenti}
\input{capitoli/AppendiceFondamenti}

% -----------------------------------------------
\chapter{Strumenti e Ambiente di Simulazione --- Trattazione Estesa}
\label{app:strumenti}
\input{capitoli/AppendiceStrumenti}

% -----------------------------------------------
\chapter{Contesto Esteso dell'Introduzione}
\label{app:introduzione}
\input{capitoli/AppendiceIntroduzione}

% -----------------------------------------------
\chapter{Dettaglio degli Obiettivi e del Piano Sperimentale}
\label{app:obiettivi}
\input{capitoli/AppendiceObiettivi}

% -----------------------------------------------
\chapter{Il Classificatore ML: Architettura, Addestramento e Metriche}
\label{app:classificatore}
\input{capitoli/AppendiceClassificatore}

% -----------------------------------------------
\chapter{Compilazione Consapevole della Struttura: un'Esplorazione}
