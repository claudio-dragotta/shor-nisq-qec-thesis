...
\medskip
\noindent\textbf{Fase 1 — Preprocessing classico}
\begin{enumerate}
...
\medskip
\noindent\textbf{Fase 2 — Circuito quantistico (period finding)}
...
\medskip
\noindent\textbf{Fase 3 — Post-elaborazione classica}
...
L'algoritmo di Shor rende teoricamente vulnerabili tutti i sistemi crittografici basati sulla difficoltà della fattorizzazione (\ac{RSA}) o del logaritmo discreto (Diffie-Hellman, \ac{DSA}, \ac{ECDSA}). La \textit{Post-Quantum Cryptography} (\ac{PQC}) è il campo emergente che sviluppa algoritmi crittografici resistenti agli attacchi quantistici.
...
\begin{tabular}{@{}lp{3.9cm}p{4.1cm}@{}}
\toprule
