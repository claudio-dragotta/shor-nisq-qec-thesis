...
\end{minipage}
\caption[Blocco di moltiplicazione modulare $U_2$ per $N=15$]{Gate di moltiplicazione modulare $U_2\ket{x} = \ket{2x \bmod 15}$ per $N=15$, $a=2$. (a) Versione non controllata su 4 qubit: implementata come sequenza di SWAP condizionati. (b) Versione controllata $CU_2$ su 5 qubit, utilizzata nel circuito QPE: il qubit $q_0$ di controllo attiva il blocco solo quando è in stato $|1\rangle$.}
...
\end{minipage}
\caption[Blocco di moltiplicazione modulare $U_4$ per $N=15$]{Gate di moltiplicazione modulare $U_4\ket{x} = \ket{4x \bmod 15}$ per $N=15$, $a=4=2^2$. Il pattern di CNOT differisce da $U_2$ poiché la permutazione modulare per $a=4$ è diversa. (b) Versione controllata $CU_4$ su 5 qubit, secondo blocco del circuito QPE.}
