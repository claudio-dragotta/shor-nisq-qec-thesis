...
La misura di quell'incrocio è però il contributo più utile, perché è negativa e
quantitativa: il vantaggio massimo ottenibile vale circa tre punti percentuali e richiede
porte a due qubit due ordini di grandezza più accurate di quelle attuali, mentre nel regime
oggi accessibile nessuna variante supera il pavimento dell'istanza. Poiché la trasformata
di Fourier è il nucleo condiviso da un'intera famiglia di algoritmi --- stima di fase,
amplitude estimation, e ogni procedura che estragga informazione spettrale --- una
metodologia che ne scelga la decomposizione in funzione della topologia e del profilo
d'errore del dispositivo si applicherebbe ben oltre la fattorizzazione. Questa tesi ne
stabilisce il perimetro di convenienza; verificarla sull'intera famiglia resta una
direzione dichiarata, non un risultato acquisito (Sezione~\ref{sec:qft_topologia}).
