...
di grandezza ottimizzata: lì si approssima l'aritmetica per risparmiare qubit, qui la
trasformata per risparmiare \textbf{porte}. Le due leve sono ortogonali e rispondono a
vincoli distinti --- il costo di realizzare e mantenere i qubit da un lato, la profondità
del circuito rispetto al tempo di coerenza dall'altro --- e nulla impedisce in linea di
principio di applicarle insieme. Una terza direzione, che riduce il registro di fase a
