...
& non verificata
& $N=21/35$ sono validati idealmente ma esclusi dalla campagna rumorosa
M1--M2 per costo;
...
Il limite che comprende tutti gli altri è che nessun risultato di questa
tesi proviene da un'esecuzione su hardware quantistico. Non si tratta di
un'occasione mancata ma di una scelta concordata: l'accesso a un
dispositivo reale è divenuto disponibile mentre il lavoro era in corso, e
si è convenuto di non impiegarlo perché le domande sperimentali erano già
state chiuse sui modelli di rumore e sulle snapshot di calibrazione.
L'intera validazione appartiene quindi a quel perimetro, e l'unico
riscontro su macchina reale che il lavoro può esibire è per citazione
(Sezione~\ref{subsec:discussione_logico}).
...
$N=21/35$ non partecipano alla campagna rumorosa principale; su $N=21$
sono state eseguite soltanto prove AQFT esplorative a budget ridotto
(Sezione~\ref{sec:app_aqft}).
...
Lo stesso criterio, applicato a monte anziché a valle, delimita la direzione con cui il
lavoro si chiude. Se il post-processing non può recuperare informazione già distrutta, la
leva rimasta è intervenire sul circuito prima che il rumore agisca: e nell'aritmetica
modulare il costo si concentra in un punto solo, le trasformate di Fourier interne agli
addizionatori, dove per $N=21$ stanno 11\,436 rotazioni controllate contro 3\,406 porte
CX. Troncarle sotto una soglia d'angolo dimezza le porte a due qubit, da 49\,661 a
23\,178, al prezzo di sei punti e mezzo di resa ideale. Il compromesso genera un incrocio:
sotto una certa qualità delle porte conviene approssimare, sopra conviene la trasformata
intera.

La stima ausiliaria a miscela quantifica un possibile incrocio. Nel proxy
il margine massimo vale circa tre punti percentuali e richiederebbe errori
a due qubit due ordini di grandezza inferiori a quelli della snapshot;
non risulta osservato nelle prove rumorose. Nel regime nominale
nessuna variante supera il pavimento dell'istanza, e il circuito di $N=21$ è
comunque centocinquanta volte più lungo del tempo di coerenza disponibile. Il limite
appartiene tuttavia all'istanza, non al metodo: ripetendo la misura sulla \textbf{stima
di fase} --- che della trasformata è l'uso canonico, e che costa decine di porte a due
qubit anziché decine di migliaia --- la trasformata troncata batte quella piena in
\textbf{tutti e nove} i confronti eseguiti, con un vantaggio che cresce fino a $+0{,}126$
su registri da dieci qubit. Il grado ottimo di troncamento non cresce con la dimensione del
registro mentre il risparmio sì, e le fasi esattamente rappresentabili guadagnano più delle
altre: quest'ultima regolarità spiega perché su $N=15$, dove l'ordine $r=4$ produce fasi
esatte in due bit, l'approssimazione risultasse gratuita, e su $N=21$ no.

Poiché la trasformata di Fourier è il nucleo condiviso da un'intera famiglia di algoritmi ---
stima di fase, amplitude estimation, e ogni procedura che estragga informazione spettrale
--- il risultato si legge come regola di progetto e non come proprietà della
fattorizzazione: conteggi e calibrazione suggeriscono gradi candidati,
mentre la selezione qui verificata usa batch di selezione e holdout
disgiunti. La verifica qui condotta impiega un solo
dispositivo e poche fasi bersaglio: estenderla ad altre topologie resta il passo successivo
(Sezione~\ref{sec:qft_topologia}).

Questa linea si colloca accanto a una direzione complementare che la letteratura recente
ha percorso più a fondo. Chevignard, Fouque e Schrottenloher~\cite{chevignard2025}
ottengono una riduzione asintotica del numero di \textbf{qubit} logici calcolando
l'aritmetica modulare in forma approssimata, e su quel risultato poggia la stima di
Gidney~\cite{gidney2025}. La differenza rispetto al lavoro qui svolto non è di merito ma
di grandezza ottimizzata, e non è una semplice ortogonalità: per RSA-2048 quel metodo
scende a 1730 qubit logici contro 6144, ma al prezzo di $2^{40{,}9}$ porte Toffoli
complessive contro $2^{31{,}3}$, perché richiede in media quaranta esecuzioni. Compra
qubit \emph{pagandoli in porte}, cioè percorre l'asse opposto a quello seguito qui.
Le due scelte rispondono a vincoli diversi --- il costo di realizzare i qubit nel regime
fault-tolerant, la profondità rispetto alla coerenza nel regime \ac{NISQ} --- e quale
domini dipende dall'orizzonte tecnologico che si assume. Una terza direzione, che riduce il registro di fase a
pochi qubit riorganizzando la stima in blocchi indipendenti~\cite{shukla2026}, agisce
su un asse ulteriore e suggerisce che la composizione delle tre meriti di essere studiata.
