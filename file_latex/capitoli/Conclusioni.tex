...
La misura di quell'incrocio è però il contributo più utile, perché è quantitativa. Su
questa istanza il vantaggio massimo vale circa tre punti percentuali e richiederebbe porte
a due qubit due ordini di grandezza più accurate di quelle attuali; nel regime oggi
accessibile nessuna variante supera il pavimento dell'istanza, e il circuito di $N=21$ è
...
fattorizzazione: il grado di troncamento conveniente è \textbf{determinabile in anticipo}
dai soli conteggi di porte del circuito compilato e dai dati di calibrazione del
dispositivo, senza eseguire l'algoritmo. La verifica qui condotta impiega però un solo
