...
Con il contratto sperimentale così definito, il Capitolo~\ref{chap:sviluppo} traduce queste specifiche in codice: presenta l'implementazione concreta del circuito di Shor, del modello di rumore e dei due metodi di analisi per ciascun use case.
