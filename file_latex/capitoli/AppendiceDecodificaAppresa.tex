...
Un secondo riscontro conferma la diagnosi. La rete impiegata come decoder \emph{autonomo} --- il braccio di sostituzione, colonna \textit{rete} della Tabella~\ref{tab:neural_ibrido} --- si degrada lungo le distanze in modo indipendente dagli esempi disponibili: a $d=3$ essa riduce l'errore rispetto al tasso di base di un fattore fra $1.5$ e $11.9$; a $d=5$ fra $1.0$ e $6.2$; a $d=7$ fra $0.99$ e $2.9$, ossia a crosstalk $\geq 0.02$ essa è \emph{indistinguibile dal tasso di base} pur disponendo di oltre centomila esempi. Non è un modello a cui manchino i dati: è un modello che, su $336$ dimensioni indipendenti, non riesce a rappresentare la funzione richiesta.
