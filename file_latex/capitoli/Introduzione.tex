...
L'esito della verifica --- l'\ac{ML} applicato all'output, in quel punto e in quel modo, non serve --- non chiude il ruolo dell'apprendimento automatico, ma lo riorienta. La \textbf{seconda fase}, che costituisce il nucleo della tesi, muove esattamente da qui: poiché gli errori di una \ac{QPU} reale sono sistematici e localizzati (qubit con tempi di coerenza diversi, linee di gate con fedeltà diverse, crosstalk dipendente dalla topologia), un modello addestrato su feature \emph{strutturali} del dispositivo può \textbf{predire dove e quando gli errori si manifesteranno}. L'obiettivo è sostituire la pratica attuale della \textbf{duplicazione dei qubit} --- che raddoppia il fabbisogno di hardware per pura ridondanza --- con la gestione predittiva degli errori: stessa affidabilità, metà dei qubit fisici.

L'elaborato si sviluppa dalle fondamenta teoriche del calcolo quantistico, attraverso la verifica sperimentale su simulatori rumorosi, fino alla proposta del sistema di gestione predittiva degli errori. Gli obiettivi specifici e la struttura dettagliata del lavoro sono descritti nel Capitolo~\ref{chap:obiettivi}.
...
L'elaborato è organizzato in dodici capitoli, più un'appendice sperimentale. Il Capitolo~2 svolge una funzione trasversale di raccordo tra teoria e pratica; i Capitoli~3--6 costituiscono la parte teorica; i Capitoli~7--12 la parte sperimentale e propositiva.
...
\medskip
\textbf{Parte sperimentale e propositiva (Capitoli 7--12).}
...
Il \textbf{Capitolo~\ref{chap:predizione}} (\textit{Gestione Predittiva degli Errori: dalla Duplicazione dei Qubit al Machine Learning}) presenta il nucleo della tesi. Descrive la natura sistematica e non uniforme degli errori hardware (tempi di coerenza diversi da qubit a qubit, fedeltà di gate diverse da linea a linea, crosstalk dipendente dalla topologia), analizza la pratica industriale attuale --- la duplicazione dei qubit, che raddoppia il fabbisogno fisico per pura ridondanza --- e presenta il sistema che questa tesi vi contrappone: un modello di apprendimento automatico addestrato sulla specifica \ac{QPU}, tramite una QPU virtuale con iniezione di errori configurabile e un dataset a verità nota, che predice dove e quando gli errori si manifestano. Il capitolo definisce l'architettura del sistema e il protocollo di validazione a tre bracci, con la duplicazione come baseline di riferimento e criteri quantitativi di successo dichiarati a priori.

Il \textbf{Capitolo~\ref{chap:sviluppi}} (\textit{Sviluppi Futuri}) delinea le direzioni di ricerca oltre il perimetro del programma predittivo: test su hardware reale, decomposizioni efficienti per la moltiplicazione modulare (approccio Beauregard), generalizzazione ad altri algoritmi NISQ e integrazione con la \ac{QEC} strutturale.
