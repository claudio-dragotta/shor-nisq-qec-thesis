...
Il \textbf{Capitolo~\ref{chap:risultati2}} (\textit{Risultati --- Metodo 2}) confronta il Metodo ML-assistito con la baseline: per UC1 il fattore di riduzione $\rho = \bar{M}_1/\bar{M}_2 = 6.44$ ($p = 0.046$, statisticamente significativo), con $\bar{M}_2 = 1.00$ iterazione. Per UC2 il metodo non produce miglioramenti significativi ($\rho = 0.731$, $p = 0.697$), evidenziando un limite del classificatore in regime ad alto rumore.
