...
Il \textbf{Capitolo~\ref{chap:risultati2}} (\textit{Risultati --- Metodo 2}) confronta il Metodo \ac{ML}-assistito con la baseline tramite analisi di ablazione: per UC1 il fattore di riduzione $\rho = 6.44$ ($p = 0.0002$), con $\bar{M}_2 = 1.00$ iterazione; per UC2 il classificatore degrada le prestazioni ($\rho = 0.731$, $p = 0.704$), mentre la variante $M_{\text{TOP4}}$ senza classificatore ottiene $\rho = 2.42$ ($p = 0.003$).
