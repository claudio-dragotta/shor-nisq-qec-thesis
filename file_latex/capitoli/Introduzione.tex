...
Il \textbf{Capitolo~\ref{chap:predizione}} (\textit{Gestione Predittiva degli Errori: dalla Duplicazione dei Qubit al Machine Learning}) presenta il nucleo della tesi. Descrive la natura sistematica e non uniforme degli errori hardware (tempi di coerenza diversi da qubit a qubit, fedeltà di gate diverse da linea a linea, crosstalk dipendente dalla topologia), analizza la pratica industriale attuale --- la duplicazione dei qubit, che raddoppia il fabbisogno fisico per pura ridondanza --- e formula la proposta: un modello di apprendimento automatico addestrato sulla specifica \ac{QPU}, tramite una QPU virtuale con iniezione di errori configurabile e un dataset a verità nota, capace di predire dove e quando gli errori si manifesteranno. Il capitolo definisce l'architettura del sistema, le ipotesi operative e i criteri quantitativi di successo, inclusa la baseline di duplicazione contro cui il modello sarà validato.
