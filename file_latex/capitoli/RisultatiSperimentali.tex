...
Il punto 2 merita di essere letto in positivo, perché delimita con precisione \emph{dove} l'apprendimento automatico non può funzionare: sul solo output, l'informazione utile è già interamente catturata da una ricerca multi-candidato a costo zero. Se l'\ac{ML} deve dare un contributo alla mitigazione degli errori di Shor, deve attingere a informazione che \emph{nell'output non c'è}: la fisica della macchina --- quali qubit sono deboli, quali linee falliscono sistematicamente, come la topologia del dispositivo propaga gli errori. È esattamente la prospettiva del prossimo capitolo, che costituisce il nucleo di questa tesi: sostituire la pratica attuale della duplicazione dei qubit con un modello predittivo degli errori addestrato sulla specifica \mbox{QPU}.
