...
Il quadro che ne esce è netto. Nel regime di rumore molto basso le due grandezze coincidono, come devono: a $\varepsilon_{2q}=10^{-3}$ il rapporto vale $1.0$ e l'esponente efficace $148$, prossimo alle $166$ porte reali. Ma già al valore nominale di UC1 la stima analitica sbaglia di un fattore quattro, e da lì in poi diverge senza limite: a $\varepsilon_{2q}=10^{-1}$ il rumore residuo conserva ancora il $16\%$ di segnale coerente là dove $P_{\text{surv}}$ prevedeva una parte su quaranta milioni.
