...
Agiscono su tre grandezze distinte --- porte, qubit di lavoro, qubit di conteggio --- e
non si ostacolano a vicenda: nulla, in linea di principio, impedisce di troncare la
trasformata di un circuito che già usi aritmetica approssimata e un registro di fase
ridotto. Verificare se i guadagni si sommino, o se una delle leve eroda il margine delle
altre, richiede un disegno sperimentale che le vari congiuntamente ed è la domanda che
questo lavoro lascia aperta con maggiore fiducia, perché le tre riduzioni sono ciascuna
già documentata.
