...
Il contesto che motiva questo lavoro --- la minaccia dell'algoritmo di Shor alla crittografia a chiave pubblica, il fenomeno \textit{harvest now, decrypt later} e la transizione verso la crittografia post-quantistica --- è analizzato in dettaglio nel Capitolo~\ref{chap:introduzione}. Partendo da quel quadro, il presente capitolo definisce le domande di ricerca e i traguardi concreti del lavoro.
