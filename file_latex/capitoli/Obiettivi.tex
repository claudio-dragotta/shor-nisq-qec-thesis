...
\begin{itemize}
    ...
    \item La parte \textbf{sperimentale} utilizza il framework Qiskit e il simulatore Aer di IBM per implementare e testare i circuiti quantistici dell'algoritmo di Shor, valutare l'impatto del rumore e confrontare le tecniche di mitigazione.
