...
strategia TOP-K, di cui il Capitolo~
ef{chap:risultati} riporta la sintesi. Il protocollo usa $N=15$, $a=7$,
...
resti nell'istogramma. La Figura~\ref{fig:app_istogrammi_qpe} mostra, fra le
...
\begin{figure}[!htbp]
    ...
    \label{fig:app_frazione_coerente}
\end{figure}
